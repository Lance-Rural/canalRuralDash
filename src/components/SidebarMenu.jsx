...
const navigation = [
  { name: "Dashboard", to: "/dashboard/home", icon: HomeIcon, current: true },
  {
    name: "Transmissões",
  ...
  { name: "Programas", to: "Home", icon: FolderIcon, current: false },
  { name: "Usuários", to: "Home", icon: CalendarIcon, current: false },
  { name: "Reports", to: "Home", icon: ChartPieIcon, current: false },
];
const teams = [
  ...
  return (
    <>
      <div>
        ...
        <div
          className={classNames(
            sidebarDesktopOpen ? "lg:w-72" : "w-28",
